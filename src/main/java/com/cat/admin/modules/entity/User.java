...
import com.cat.admin.core.validator.Create;
import com.cat.admin.core.validator.FieldRepeatValidator;
import com.cat.admin.core.validator.Update;
...
//	@FieldRepeatValidator(className = "com.cat.modules.system.entity.User", field = "pwd", message = "密码重复！")
//	@FieldRepeatValidator(className = "com.cat.modules.system.entity.User", field = "pwd", message = "密码重复！",groups={FieldRepeatValidator.class})
	private String pwd;
    /**
     * 昵称
     */
