package com.cat.admin.core.config.security.filter;
...
import com.cat.admin.core.config.security.service.impl.UserDetailsServiceImpl;
import com.cat.admin.core.utils.MultiReadHttpServletRequest;
import com.cat.admin.core.utils.MultiReadHttpServletResponse;
...
public class MyAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        /*if ((request.getContentType() == null && request.getContentLength() > 0)
                ...
                && !request.getContentType().contains(Constants.REQUEST_HEADERS_MULTIPART_TYPE))) {
